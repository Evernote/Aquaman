...
describe('Aquaman', () => {
  ...
  describe('#initializeFlow', () => {
    ...
    it('can persist a position in the flow', () => {
      const actionSeries = [{ type: 'step1' }, { type: 'step2' }, { type: 'step3' }];
  ...
  describe('#next', () => {
    ...
    it('can handle branching', () => {
      const actionSeries = [
        { type: 'step1' },
        {
          ...
          1: [
            { type: 'branch1' },
            { __BRANCH__: true, 0: [{ type: 'branch3' }], 1: [{ type: 'branch4' }] },
            { type: 'step4' },
          ],
        },
        {
    ...
    it('can handle actionCreators', () => {
      ...
      expect(dispatch).toHaveBeenCalledWith({ type: 'step2', data: 'someData' });
    });
    ...
    it('can handle a normal function with no dispatch', () => {
      ...
      const actionSeries = [{ type: 'step1' }, [stepFunc, '__Aquaman_END_FLOW__']];
    ...
    it('can handle a mapped function', () => {
      ...
      const actionSeries = [
        { type: 'step1' },
        [
          { __Aquaman_FUNCTION__: true, functionName: 'stepFunc', args: ['a', 'b'] },
          '__Aquaman_END_FLOW__',
        ],
      ];
